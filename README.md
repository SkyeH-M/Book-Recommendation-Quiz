...
| 10. I discovered that there was no limit to how many characters users could enter into the username field. This would mean that when being greeted by their name in the recommendation area the large amount of characters would flood the page and create disharmony between other elements nearby | Yes | I added a username input field maxlength property set to limit a username to 15 characters |
